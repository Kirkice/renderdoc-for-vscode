...
5. Look for common issues: overdraw, redundant state changes, large textures, excessive draw calls, unused bindings, mismatched blend/depth state.
6. Reference events by EID in your response (e.g. "EID 142") so the user can navigate.
